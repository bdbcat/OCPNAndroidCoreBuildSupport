...
void QAbstractAnimation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QAbstractAnimation::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QAbstractAnimation::finished)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QAbstractAnimation::*)(QAbstractAnimation::State , QAbstractAnimation::State );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QAbstractAnimation::stateChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QAbstractAnimation::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QAbstractAnimation::currentLoopChanged)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QAbstractAnimation::*)(QAbstractAnimation::Direction );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QAbstractAnimation::directionChanged)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QAbstractAnimation::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QAbstractAnimation.data,
    qt_meta_data_QAbstractAnimation,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void QAnimationDriver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (QAnimationDriver::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QAnimationDriver::started)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QAnimationDriver::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QAnimationDriver::stopped)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QAnimationDriver::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QAnimationDriver.data,
    qt_meta_data_QAnimationDriver,
    qt_static_metacall,
    nullptr,
    nullptr
} };
