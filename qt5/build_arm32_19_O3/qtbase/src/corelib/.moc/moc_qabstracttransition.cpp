...
#include "../../../../../qtbase/src/corelib/statemachine/qabstracttransition.h"
...
void QAbstractTransition::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QAbstractTransition *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QAbstractTransition::*)(QPrivateSignal);
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QAbstractTransition::triggered)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QAbstractTransition::*)(QPrivateSignal);
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QAbstractTransition::targetStateChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QAbstractTransition::*)(QPrivateSignal);
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QAbstractTransition::targetStatesChanged)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QAbstractTransition::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QAbstractTransition.data,
    qt_meta_data_QAbstractTransition,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void QAbstractTransition::triggered(QPrivateSignal _t1)
{
...
// SIGNAL 1
void QAbstractTransition::targetStateChanged(QPrivateSignal _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void QAbstractTransition::targetStatesChanged(QPrivateSignal _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
