...
#include "../../../../../qtbase/src/corelib/animation/qanimationgroup.h"
...
QT_INIT_METAOBJECT const QMetaObject QAnimationGroup::staticMetaObject = { {
    &QAbstractAnimation::staticMetaObject,
    qt_meta_stringdata_QAnimationGroup.data,
