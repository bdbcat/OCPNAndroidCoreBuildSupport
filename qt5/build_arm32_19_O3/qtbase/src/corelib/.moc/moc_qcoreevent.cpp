...
QT_MOC_LITERAL(171, 2556, 20), // "TabletTrackingChange"
QT_MOC_LITERAL(172, 2577, 4), // "User"
QT_MOC_LITERAL(173, 2582, 7) // "MaxUser"
    ...
    "Pointer\0TabletTrackingChange\0User\0"
    "MaxUser"
};
...
static const uint qt_meta_data_QEvent[] = {
 ...
 // enum data: key, value
     ...
     172, uint(QEvent::User),
     173, uint(QEvent::MaxUser),

       0        // eod
};

QT_INIT_METAOBJECT const QMetaObject QEvent::staticMetaObject = { {
    nullptr,
    qt_meta_stringdata_QEvent.data,
    qt_meta_data_QEvent,
    nullptr,
    nullptr,
    nullptr
