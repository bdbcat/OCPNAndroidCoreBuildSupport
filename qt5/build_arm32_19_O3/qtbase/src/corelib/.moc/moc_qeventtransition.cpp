...
#include "../../../../../qtbase/src/corelib/statemachine/qeventtransition.h"
...
void QEventTransition::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<QEventTransition *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QEventTransition::staticMetaObject = { {
    &QAbstractTransition::staticMetaObject,
    qt_meta_stringdata_QEventTransition.data,
    qt_meta_data_QEventTransition,
    qt_static_metacall,
    qt_meta_extradata_QEventTransition,
    nullptr
} };
