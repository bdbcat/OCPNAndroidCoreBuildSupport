...
#include "../../../../../qtbase/src/corelib/io/qfilesystemwatcher_p.h"
...
void QFileSystemWatcherEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QFileSystemWatcherEngine::fileChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QFileSystemWatcherEngine::*)(const QString & , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QFileSystemWatcherEngine::directoryChanged)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QFileSystemWatcherEngine::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QFileSystemWatcherEngine.data,
    qt_meta_data_QFileSystemWatcherEngine,
    qt_static_metacall,
    nullptr,
    nullptr
} };
