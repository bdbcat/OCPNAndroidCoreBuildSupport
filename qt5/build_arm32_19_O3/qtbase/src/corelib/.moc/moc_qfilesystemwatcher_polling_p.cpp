...
#include "../../../../../qtbase/src/corelib/io/qfilesystemwatcher_polling_p.h"
...
void QPollingFileSystemWatcherEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QPollingFileSystemWatcherEngine *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QPollingFileSystemWatcherEngine::staticMetaObject = { {
    &QFileSystemWatcherEngine::staticMetaObject,
    qt_meta_stringdata_QPollingFileSystemWatcherEngine.data,
    qt_meta_data_QPollingFileSystemWatcherEngine,
    qt_static_metacall,
    nullptr,
    nullptr
} };
