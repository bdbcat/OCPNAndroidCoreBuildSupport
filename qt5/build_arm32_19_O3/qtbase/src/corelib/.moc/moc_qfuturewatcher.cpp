...
void QFutureWatcherBase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QFutureWatcherBase::started)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QFutureWatcherBase::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QFutureWatcherBase::finished)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QFutureWatcherBase::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QFutureWatcherBase::canceled)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QFutureWatcherBase::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QFutureWatcherBase::paused)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (QFutureWatcherBase::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QFutureWatcherBase::resumed)) {
                *result = 4;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QFutureWatcherBase::resultReadyAt)) {
                *result = 5;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QFutureWatcherBase::resultsReadyAt)) {
                *result = 6;
                return;
            }
        }
        {
            using _t = void (QFutureWatcherBase::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QFutureWatcherBase::progressRangeChanged)) {
                *result = 7;
                return;
            }
        }
        {
            using _t = void (QFutureWatcherBase::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QFutureWatcherBase::progressValueChanged)) {
                *result = 8;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QFutureWatcherBase::progressTextChanged)) {
                *result = 9;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QFutureWatcherBase::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QFutureWatcherBase.data,
    qt_meta_data_QFutureWatcherBase,
    qt_static_metacall,
    nullptr,
    nullptr
} };
