...
#include "../../../../../qtbase/src/corelib/statemachine/qhistorystate.h"
...
void QHistoryState::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QHistoryState *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QHistoryState::*)(QPrivateSignal);
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHistoryState::defaultTransitionChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QHistoryState::*)(QPrivateSignal);
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHistoryState::defaultStateChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QHistoryState::*)(QPrivateSignal);
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHistoryState::historyTypeChanged)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QHistoryState::staticMetaObject = { {
    &QAbstractState::staticMetaObject,
    qt_meta_stringdata_QHistoryState.data,
    qt_meta_data_QHistoryState,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void QHistoryState::defaultTransitionChanged(QPrivateSignal _t1)
{
...
// SIGNAL 1
void QHistoryState::defaultStateChanged(QPrivateSignal _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void QHistoryState::historyTypeChanged(QPrivateSignal _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
