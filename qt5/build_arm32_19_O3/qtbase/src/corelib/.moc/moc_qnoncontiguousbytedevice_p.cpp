...
void QNonContiguousByteDevice::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNonContiguousByteDevice::readyRead)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNonContiguousByteDevice::readProgress)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QNonContiguousByteDevice::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QNonContiguousByteDevice.data,
    qt_meta_data_QNonContiguousByteDevice,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject QNonContiguousByteDeviceIoDeviceImpl::staticMetaObject = { {
    &QNonContiguousByteDevice::staticMetaObject,
    qt_meta_stringdata_QNonContiguousByteDeviceIoDeviceImpl.data,
    qt_meta_data_QNonContiguousByteDeviceIoDeviceImpl,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject QNonContiguousByteDeviceBufferImpl::staticMetaObject = { {
    &QNonContiguousByteDevice::staticMetaObject,
    qt_meta_stringdata_QNonContiguousByteDeviceBufferImpl.data,
    qt_meta_data_QNonContiguousByteDeviceBufferImpl,
    qt_static_metacall,
    nullptr,
    nullptr
} };
