...
#include "../../../../../qtbase/src/corelib/kernel/qobjectcleanuphandler.h"
...
QT_INIT_METAOBJECT const QMetaObject QObjectCleanupHandler::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QObjectCleanupHandler.data,
