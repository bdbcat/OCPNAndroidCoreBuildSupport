...
QT_INIT_METAOBJECT const QMetaObject QPluginLoader::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QPluginLoader.data,
    qt_meta_data_QPluginLoader,
    qt_static_metacall,
    qt_meta_extradata_QPluginLoader,
    nullptr
} };
