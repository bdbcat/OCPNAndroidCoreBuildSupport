...
#include "../../../../../qtbase/src/corelib/kernel/qsignalmapper.h"
...
void QSignalMapper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QSignalMapper::mapped)) {
                *result = 0;
                return;
            }
        }
        ...
        {
            using _t = void (QSignalMapper::*)(QWidget * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QSignalMapper::mapped)) {
                *result = 2;
                return;
            }
...
QT_INIT_METAOBJECT const QMetaObject QSignalMapper::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QSignalMapper.data,
    qt_meta_data_QSignalMapper,
    qt_static_metacall,
    nullptr,
    nullptr
} };
