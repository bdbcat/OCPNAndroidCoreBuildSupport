...
#include "../../../../../qtbase/src/corelib/statemachine/qstate.h"
...
void QState::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QState::*)(QPrivateSignal);
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QState::finished)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QState::*)(QPrivateSignal);
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QState::propertiesAssigned)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QState::*)(QPrivateSignal);
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QState::childModeChanged)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QState::*)(QPrivateSignal);
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QState::initialStateChanged)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (QState::*)(QPrivateSignal);
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QState::errorStateChanged)) {
                *result = 4;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QState::staticMetaObject = { {
    &QAbstractState::staticMetaObject,
    qt_meta_stringdata_QState.data,
    qt_meta_data_QState,
    qt_static_metacall,
    nullptr,
    nullptr
...
// SIGNAL 0
void QState::finished(QPrivateSignal _t1)
{
...
// SIGNAL 1
void QState::propertiesAssigned(QPrivateSignal _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void QState::childModeChanged(QPrivateSignal _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 3
void QState::initialStateChanged(QPrivateSignal _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 4
void QState::errorStateChanged(QPrivateSignal _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
