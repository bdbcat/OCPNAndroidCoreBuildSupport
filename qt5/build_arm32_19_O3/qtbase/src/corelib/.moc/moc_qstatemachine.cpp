...
#include "../../../../../qtbase/src/corelib/statemachine/qstatemachine.h"
...
void QStateMachine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QStateMachine *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QStateMachine::*)(QPrivateSignal);
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QStateMachine::started)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QStateMachine::*)(QPrivateSignal);
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QStateMachine::stopped)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QStateMachine::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QStateMachine::runningChanged)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QStateMachine::staticMetaObject = { {
    &QState::staticMetaObject,
    qt_meta_stringdata_QStateMachine.data,
    qt_meta_data_QStateMachine,
    qt_static_metacall,
    qt_meta_extradata_QStateMachine,
    nullptr
} };
...
// SIGNAL 0
void QStateMachine::started(QPrivateSignal _t1)
{
...
// SIGNAL 1
void QStateMachine::stopped(QPrivateSignal _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
