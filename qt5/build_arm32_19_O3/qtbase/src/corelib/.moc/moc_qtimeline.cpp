...
#include "../../../../../qtbase/src/corelib/tools/qtimeline.h"
...
void QTimeLine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QTimeLine::*)(qreal , QPrivateSignal);
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTimeLine::valueChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QTimeLine::*)(int , QPrivateSignal);
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTimeLine::frameChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QTimeLine::*)(QTimeLine::State , QPrivateSignal);
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTimeLine::stateChanged)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QTimeLine::*)(QPrivateSignal);
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTimeLine::finished)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QTimeLine::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QTimeLine.data,
    qt_meta_data_QTimeLine,
    qt_static_metacall,
    nullptr,
    nullptr
} };
