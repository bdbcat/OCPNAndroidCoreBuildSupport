...
#include "../../../../../qtbase/src/corelib/animation/qvariantanimation.h"
...
void QVariantAnimation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QVariantAnimation::*)(const QVariant & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QVariantAnimation::valueChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QVariantAnimation::staticMetaObject = { {
    &QAbstractAnimation::staticMetaObject,
    qt_meta_stringdata_QVariantAnimation.data,
    qt_meta_data_QVariantAnimation,
    qt_static_metacall,
    nullptr,
    nullptr
} };
