...
void QMovie::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QMovie::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QMovie::started)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QMovie::*)(const QSize & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QMovie::resized)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QMovie::*)(const QRect & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QMovie::updated)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QMovie::*)(QMovie::MovieState );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QMovie::stateChanged)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (QMovie::*)(QImageReader::ImageReaderError );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QMovie::error)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (QMovie::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QMovie::finished)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (QMovie::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QMovie::frameChanged)) {
                *result = 6;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QMovie::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QMovie.data,
    qt_meta_data_QMovie,
    qt_static_metacall,
    nullptr,
    nullptr
