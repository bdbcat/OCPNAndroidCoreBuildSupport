...
void QPlatformMenuItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QPlatformMenuItem::activated)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QPlatformMenuItem::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QPlatformMenuItem::hovered)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QPlatformMenuItem::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QPlatformMenuItem.data,
    qt_meta_data_QPlatformMenuItem,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void QPlatformMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QPlatformMenu::aboutToShow)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QPlatformMenu::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QPlatformMenu::aboutToHide)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QPlatformMenu::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QPlatformMenu.data,
    qt_meta_data_QPlatformMenu,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject QPlatformMenuBar::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QPlatformMenuBar.data,
    qt_meta_data_QPlatformMenuBar,
    qt_static_metacall,
    nullptr,
    nullptr
} };
