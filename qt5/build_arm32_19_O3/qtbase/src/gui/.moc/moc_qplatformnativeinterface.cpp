...
#include "../../../../../qtbase/src/gui/kernel/qplatformnativeinterface.h"
...
void QPlatformNativeInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QPlatformNativeInterface *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QPlatformNativeInterface::*)(QPlatformWindow * , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QPlatformNativeInterface::windowPropertyChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QPlatformNativeInterface::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QPlatformNativeInterface.data,
    qt_meta_data_QPlatformNativeInterface,
    qt_static_metacall,
    nullptr,
    nullptr
} };
