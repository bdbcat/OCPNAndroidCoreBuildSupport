...
#include "../../../../../qtbase/src/gui/kernel/qplatformsharedgraphicscache.h"
...
void QPlatformSharedGraphicsCache::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QPlatformSharedGraphicsCache::*)(const QByteArray & , const QVector<quint32> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QPlatformSharedGraphicsCache::itemsMissing)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QPlatformSharedGraphicsCache::*)(const QByteArray & , void * , const QVector<quint32> & , const QVector<QPoint> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QPlatformSharedGraphicsCache::itemsAvailable)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QPlatformSharedGraphicsCache::*)(const QByteArray & , const QVector<quint32> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QPlatformSharedGraphicsCache::itemsInvalidated)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QPlatformSharedGraphicsCache::*)(const QByteArray & , void * , const QVector<quint32> & , const QVector<QPoint> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QPlatformSharedGraphicsCache::itemsUpdated)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QPlatformSharedGraphicsCache::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QPlatformSharedGraphicsCache.data,
    qt_meta_data_QPlatformSharedGraphicsCache,
    qt_static_metacall,
    nullptr,
    nullptr
} };
