...
QT_MOC_LITERAL(7, 83, 7), // "topLeft"
QT_MOC_LITERAL(8, 91, 11), // "bottomRight"
QT_MOC_LITERAL(9, 103, 8) // "sortRole"
...
void QStandardItemModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QStandardItemModel::itemChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QStandardItemModel::staticMetaObject = { {
    &QAbstractItemModel::staticMetaObject,
    qt_meta_stringdata_QStandardItemModel.data,
    qt_meta_data_QStandardItemModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
