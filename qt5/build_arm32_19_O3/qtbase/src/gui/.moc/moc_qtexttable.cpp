...
#include "../../../../../qtbase/src/gui/text/qtexttable.h"
...
QT_INIT_METAOBJECT const QMetaObject QTextTable::staticMetaObject = { {
    &QTextFrame::staticMetaObject,
    qt_meta_stringdata_QTextTable.data,
    qt_meta_data_QTextTable,
    qt_static_metacall,
    nullptr,
    nullptr
} };
