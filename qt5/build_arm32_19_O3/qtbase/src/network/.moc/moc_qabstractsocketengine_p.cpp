...
QT_INIT_METAOBJECT const QMetaObject QAbstractSocketEngine::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QAbstractSocketEngine.data,
    qt_meta_data_QAbstractSocketEngine,
    qt_static_metacall,
    nullptr,
    nullptr
} };
