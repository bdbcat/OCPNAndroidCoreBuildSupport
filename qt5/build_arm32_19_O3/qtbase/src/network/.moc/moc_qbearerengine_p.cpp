...
#include "../../../../../qtbase/src/network/bearer/qbearerengine_p.h"
...
void QBearerEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QBearerEngine *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QBearerEngine::*)(QNetworkConfigurationPrivatePointer );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QBearerEngine::configurationAdded)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QBearerEngine::*)(QNetworkConfigurationPrivatePointer );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QBearerEngine::configurationRemoved)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QBearerEngine::*)(QNetworkConfigurationPrivatePointer );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QBearerEngine::configurationChanged)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QBearerEngine::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QBearerEngine::updateCompleted)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QBearerEngine::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QBearerEngine.data,
    qt_meta_data_QBearerEngine,
    qt_static_metacall,
    nullptr,
    nullptr
} };
