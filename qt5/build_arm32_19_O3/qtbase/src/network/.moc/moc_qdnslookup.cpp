...
void QDnsLookup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QDnsLookup::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDnsLookup::finished)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QDnsLookup::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDnsLookup::nameChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QDnsLookup::*)(Type );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDnsLookup::typeChanged)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QDnsLookup::*)(const QHostAddress & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDnsLookup::nameserverChanged)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QDnsLookup::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QDnsLookup.data,
    qt_meta_data_QDnsLookup,
    qt_static_metacall,
    nullptr,
    nullptr
} };
