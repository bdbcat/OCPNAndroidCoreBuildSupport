...
#include "../../../../../qtbase/src/network/kernel/qdnslookup_p.h"
...
void QDnsLookupRunnable::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDnsLookupRunnable::finished)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QDnsLookupRunnable::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QDnsLookupRunnable.data,
    qt_meta_data_QDnsLookupRunnable,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QDnsLookupThreadPool *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QDnsLookupThreadPool::staticMetaObject = { {
    &QThreadPool::staticMetaObject,
    qt_meta_stringdata_QDnsLookupThreadPool.data,
    qt_meta_data_QDnsLookupThreadPool,
    qt_static_metacall,
    nullptr,
    nullptr
} };
