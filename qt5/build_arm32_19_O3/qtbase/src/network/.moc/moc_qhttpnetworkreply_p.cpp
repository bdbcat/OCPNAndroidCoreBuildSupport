...
void QHttpNetworkReply::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QHttpNetworkReply::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHttpNetworkReply::readyRead)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QHttpNetworkReply::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHttpNetworkReply::finished)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QHttpNetworkReply::*)(QNetworkReply::NetworkError , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHttpNetworkReply::finishedWithError)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QHttpNetworkReply::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHttpNetworkReply::headerChanged)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (QHttpNetworkReply::*)(qint64 , qint64 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHttpNetworkReply::dataReadProgress)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (QHttpNetworkReply::*)(qint64 , qint64 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHttpNetworkReply::dataSendProgress)) {
                *result = 6;
                return;
            }
        }
        {
            using _t = void (QHttpNetworkReply::*)(const QHttpNetworkRequest & , QAuthenticator * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHttpNetworkReply::cacheCredentials)) {
                *result = 7;
                return;
            }
        }
        {
            using _t = void (QHttpNetworkReply::*)(const QNetworkProxy & , QAuthenticator * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHttpNetworkReply::proxyAuthenticationRequired)) {
                *result = 8;
                return;
            }
        }
        {
            using _t = void (QHttpNetworkReply::*)(const QHttpNetworkRequest & , QAuthenticator * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHttpNetworkReply::authenticationRequired)) {
                *result = 9;
                return;
            }
        }
        {
            using _t = void (QHttpNetworkReply::*)(const QUrl & , int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHttpNetworkReply::redirected)) {
                *result = 10;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QHttpNetworkReply::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QHttpNetworkReply.data,
    qt_meta_data_QHttpNetworkReply,
    qt_static_metacall,
    nullptr,
    nullptr
} };
