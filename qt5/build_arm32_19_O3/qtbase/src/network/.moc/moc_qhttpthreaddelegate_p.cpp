...
static const uint qt_meta_data_QHttpThreadDelegate[] = {
 ...
 // signals: name, argc, parameters, tag, flags
       ...
       8,    8,  154,    2, 0x06 /* Public */,
      11,    2,  171,    2, 0x06 /* Public */,
      12,    1,  176,    2, 0x06 /* Public */,
      13,    2,  179,    2, 0x06 /* Public */,
 ...
 // slots: name, argc, parameters, tag, flags
      ...
      26,    0,  201,    2, 0x09 /* Protected */,
      27,    0,  202,    2, 0x09 /* Protected */,
      28,    2,  203,    2, 0x09 /* Protected */,
      28,    1,  208,    2, 0x29 /* Protected | MethodCloned */,
      31,    0,  211,    2, 0x09 /* Protected */,
      32,    2,  212,    2, 0x09 /* Protected */,
      32,    1,  217,    2, 0x29 /* Protected | MethodCloned */,
      33,    0,  220,    2, 0x09 /* Protected */,
      34,    0,  221,    2, 0x09 /* Protected */,
      35,    2,  222,    2, 0x09 /* Protected */,
      38,    2,  227,    2, 0x09 /* Protected */,
      40,    2,  232,    2, 0x09 /* Protected */,
      41,    2,  237,    2, 0x09 /* Protected */,

 // signals: parameters
    QMetaType::Void, 0x80000000 | 3, 0x80000000 | 5,    4,    2,
    QMetaType::Void, 0x80000000 | 7, 0x80000000 | 5,    2,    2,
    QMetaType::Void, 0x80000000 | 9, QMetaType::Int, QMetaType::QString, QMetaType::Bool, 0x80000000 | 10, QMetaType::LongLong, QMetaType::LongLong, QMetaType::Bool,    2,    2,    2,    2,    2,    2,    2,    2,
...
void QHttpThreadDelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->downloadMetaData((*reinterpret_cast< const QList<QPair<QByteArray,QByteArray> >(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< const QString(*)>(_a[3])),(*reinterpret_cast< bool(*)>(_a[4])),(*reinterpret_cast< QSharedPointer<char>(*)>(_a[5])),(*reinterpret_cast< qint64(*)>(_a[6])),(*reinterpret_cast< qint64(*)>(_a[7])),(*reinterpret_cast< bool(*)>(_a[8]))); break;
        ...
        {
            using _t = void (QHttpThreadDelegate::*)(const QHttpNetworkRequest & , QAuthenticator * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHttpThreadDelegate::authenticationRequired)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QHttpThreadDelegate::*)(const QNetworkProxy & , QAuthenticator * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHttpThreadDelegate::proxyAuthenticationRequired)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QHttpThreadDelegate::*)(const QList<QPair<QByteArray,QByteArray> > & , int , const QString & , bool , QSharedPointer<char> , qint64 , qint64 , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHttpThreadDelegate::downloadMetaData)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QHttpThreadDelegate::*)(qint64 , qint64 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHttpThreadDelegate::downloadProgress)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (QHttpThreadDelegate::*)(const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHttpThreadDelegate::downloadData)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (QHttpThreadDelegate::*)(QNetworkReply::NetworkError , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHttpThreadDelegate::error)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (QHttpThreadDelegate::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHttpThreadDelegate::downloadFinished)) {
                *result = 6;
                return;
            }
        }
        {
            using _t = void (QHttpThreadDelegate::*)(const QUrl & , int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHttpThreadDelegate::redirected)) {
                *result = 7;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QHttpThreadDelegate::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QHttpThreadDelegate.data,
    qt_meta_data_QHttpThreadDelegate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 2
void QHttpThreadDelegate::downloadMetaData(const QList<QPair<QByteArray,QByteArray> > & _t1, int _t2, const QString & _t3, bool _t4, QSharedPointer<char> _t5, qint64 _t6, qint64 _t7, bool _t8)
{
...
void QNonContiguousByteDeviceThreadForwardImpl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (QNonContiguousByteDeviceThreadForwardImpl::*)(qint64 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNonContiguousByteDeviceThreadForwardImpl::wantData)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QNonContiguousByteDeviceThreadForwardImpl::*)(qint64 , qint64 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNonContiguousByteDeviceThreadForwardImpl::processedData)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QNonContiguousByteDeviceThreadForwardImpl::*)(bool * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNonContiguousByteDeviceThreadForwardImpl::resetData)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QNonContiguousByteDeviceThreadForwardImpl::staticMetaObject = { {
    &QNonContiguousByteDevice::staticMetaObject,
    qt_meta_stringdata_QNonContiguousByteDeviceThreadForwardImpl.data,
    qt_meta_data_QNonContiguousByteDeviceThreadForwardImpl,
    qt_static_metacall,
    nullptr,
    nullptr
} };
