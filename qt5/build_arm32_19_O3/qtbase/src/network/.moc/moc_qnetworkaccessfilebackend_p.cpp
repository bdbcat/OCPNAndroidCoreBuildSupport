...
QT_INIT_METAOBJECT const QMetaObject QNetworkAccessFileBackend::staticMetaObject = { {
    &QNetworkAccessBackend::staticMetaObject,
    qt_meta_stringdata_QNetworkAccessFileBackend.data,
    qt_meta_data_QNetworkAccessFileBackend,
    qt_static_metacall,
    nullptr,
    nullptr
} };
