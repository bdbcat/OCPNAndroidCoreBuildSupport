...
#include "../../../../../qtbase/src/network/access/qnetworkaccessftpbackend_p.h"
...
void QNetworkAccessFtpBackend::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QNetworkAccessFtpBackend *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QNetworkAccessFtpBackend::staticMetaObject = { {
    &QNetworkAccessBackend::staticMetaObject,
    qt_meta_stringdata_QNetworkAccessFtpBackend.data,
    qt_meta_data_QNetworkAccessFtpBackend,
    qt_static_metacall,
    nullptr,
    nullptr
} };
