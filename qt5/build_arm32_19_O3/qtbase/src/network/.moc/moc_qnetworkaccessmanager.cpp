...
QT_MOC_LITERAL(32, 671, 20), // "UnknownAccessibility"
QT_MOC_LITERAL(33, 692, 13), // "NotAccessible"
QT_MOC_LITERAL(34, 706, 10) // "Accessible"
    ...
    "networkAccessible\0NetworkAccessibility\0"
...
static const uint qt_meta_data_QNetworkAccessManager[] = {
 ...
 // enum data: key, value
      32, uint(QNetworkAccessManager::UnknownAccessibility),
      33, uint(QNetworkAccessManager::NotAccessible),
      34, uint(QNetworkAccessManager::Accessible),
...
void QNetworkAccessManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QNetworkAccessManager::*)(const QNetworkProxy & , QAuthenticator * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNetworkAccessManager::proxyAuthenticationRequired)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QNetworkAccessManager::*)(QNetworkReply * , QAuthenticator * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNetworkAccessManager::authenticationRequired)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QNetworkAccessManager::*)(QNetworkReply * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNetworkAccessManager::finished)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QNetworkAccessManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNetworkAccessManager::networkSessionConnected)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (QNetworkAccessManager::*)(QNetworkAccessManager::NetworkAccessibility );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNetworkAccessManager::networkAccessibleChanged)) {
                *result = 4;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QNetworkAccessManager::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QNetworkAccessManager.data,
    qt_meta_data_QNetworkAccessManager,
    qt_static_metacall,
    nullptr,
    nullptr
} };
