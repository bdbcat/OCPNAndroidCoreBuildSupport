...
#include "../../../../../qtbase/src/network/bearer/qnetworkconfigmanager_p.h"
...
void QNetworkConfigurationManagerPrivate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QNetworkConfigurationManagerPrivate *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QNetworkConfigurationManagerPrivate::*)(const QNetworkConfiguration & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNetworkConfigurationManagerPrivate::configurationAdded)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QNetworkConfigurationManagerPrivate::*)(const QNetworkConfiguration & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNetworkConfigurationManagerPrivate::configurationRemoved)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QNetworkConfigurationManagerPrivate::*)(const QNetworkConfiguration & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNetworkConfigurationManagerPrivate::configurationChanged)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QNetworkConfigurationManagerPrivate::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNetworkConfigurationManagerPrivate::configurationUpdateComplete)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (QNetworkConfigurationManagerPrivate::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNetworkConfigurationManagerPrivate::onlineStateChanged)) {
                *result = 4;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QNetworkConfigurationManagerPrivate::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QNetworkConfigurationManagerPrivate.data,
    qt_meta_data_QNetworkConfigurationManagerPrivate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
