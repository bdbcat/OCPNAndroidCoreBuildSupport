...
#include "../../../../../qtbase/src/network/bearer/qnetworksession.h"
...
void QNetworkSession::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QNetworkSession *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QNetworkSession::*)(QNetworkSession::State );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNetworkSession::stateChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QNetworkSession::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNetworkSession::opened)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QNetworkSession::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNetworkSession::closed)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QNetworkSession::*)(QNetworkSession::SessionError );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNetworkSession::error)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (QNetworkSession::*)(const QNetworkConfiguration & , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNetworkSession::preferredConfigurationChanged)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (QNetworkSession::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNetworkSession::newConfigurationActivated)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (QNetworkSession::*)(QNetworkSession::UsagePolicies );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNetworkSession::usagePoliciesChanged)) {
                *result = 6;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QNetworkSession::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QNetworkSession.data,
    qt_meta_data_QNetworkSession,
    qt_static_metacall,
    nullptr,
    nullptr
} };
