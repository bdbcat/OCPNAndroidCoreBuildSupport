...
void QNetworkSessionPrivate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QNetworkSessionPrivate *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QNetworkSessionPrivate::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNetworkSessionPrivate::quitPendingWaitsForOpened)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QNetworkSessionPrivate::*)(QNetworkSession::SessionError );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNetworkSessionPrivate::error)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QNetworkSessionPrivate::*)(QNetworkSession::State );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNetworkSessionPrivate::stateChanged)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QNetworkSessionPrivate::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNetworkSessionPrivate::closed)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (QNetworkSessionPrivate::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNetworkSessionPrivate::newConfigurationActivated)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (QNetworkSessionPrivate::*)(const QNetworkConfiguration & , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNetworkSessionPrivate::preferredConfigurationChanged)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (QNetworkSessionPrivate::*)(QNetworkSession::UsagePolicies );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNetworkSessionPrivate::usagePoliciesChanged)) {
                *result = 6;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QNetworkSessionPrivate::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QNetworkSessionPrivate.data,
    qt_meta_data_QNetworkSessionPrivate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
