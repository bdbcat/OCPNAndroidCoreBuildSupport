...
#include "../../../../../../qtbase/src/platformsupport/input/evdevtouch/qevdevtouchhandler_p.h"
...
QT_MOC_LITERAL(1, 25, 18), // "touchPointsUpdated"
QT_MOC_LITERAL(2, 44, 0) // ""

    },
    "QEvdevTouchScreenHandler\0touchPointsUpdated\0"
    ""
};
...
void QEvdevTouchScreenHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QEvdevTouchScreenHandler::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QEvdevTouchScreenHandler::touchPointsUpdated)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QEvdevTouchScreenHandler::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QEvdevTouchScreenHandler.data,
    qt_meta_data_QEvdevTouchScreenHandler,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void QEvdevTouchScreenHandlerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (QEvdevTouchScreenHandlerThread::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QEvdevTouchScreenHandlerThread::touchDeviceRegistered)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QEvdevTouchScreenHandlerThread::staticMetaObject = { {
    &QDaemonThread::staticMetaObject,
    qt_meta_stringdata_QEvdevTouchScreenHandlerThread.data,
    qt_meta_data_QEvdevTouchScreenHandlerThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
