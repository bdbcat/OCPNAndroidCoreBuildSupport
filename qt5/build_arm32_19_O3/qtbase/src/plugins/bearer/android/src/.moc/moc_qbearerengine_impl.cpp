...
#include "../../../../../../../../qtbase/src/plugins/bearer/qbearerengine_impl.h"
...
void QBearerEngineImpl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QBearerEngineImpl *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QBearerEngineImpl::*)(const QString & , QBearerEngineImpl::ConnectionError );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QBearerEngineImpl::connectionError)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QBearerEngineImpl::staticMetaObject = { {
    &QBearerEngine::staticMetaObject,
    qt_meta_stringdata_QBearerEngineImpl.data,
    qt_meta_data_QBearerEngineImpl,
    qt_static_metacall,
    nullptr,
    nullptr
} };
