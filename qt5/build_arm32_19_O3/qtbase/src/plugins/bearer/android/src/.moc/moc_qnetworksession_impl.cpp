...
#include "../../../../../../../../qtbase/src/plugins/bearer/qnetworksession_impl.h"
...
void QNetworkSessionPrivateImpl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QNetworkSessionPrivateImpl *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QNetworkSessionPrivateImpl::staticMetaObject = { {
    &QNetworkSessionPrivate::staticMetaObject,
    qt_meta_stringdata_QNetworkSessionPrivateImpl.data,
    qt_meta_data_QNetworkSessionPrivateImpl,
    qt_static_metacall,
    nullptr,
    nullptr
} };
