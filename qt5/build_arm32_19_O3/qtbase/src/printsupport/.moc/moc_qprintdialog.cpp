...
#include "../../../../../qtbase/src/printsupport/dialogs/qprintdialog.h"
...
void QPrintDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QPrintDialog::*)(QPrinter * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QPrintDialog::accepted)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QPrintDialog::staticMetaObject = { {
    &QAbstractPrintDialog::staticMetaObject,
    qt_meta_stringdata_QPrintDialog.data,
    qt_meta_data_QPrintDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
