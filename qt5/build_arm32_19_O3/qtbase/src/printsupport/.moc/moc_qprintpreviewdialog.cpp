...
#include "../../../../../qtbase/src/printsupport/dialogs/qprintpreviewdialog.h"
...
void QPrintPreviewDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QPrintPreviewDialog::*)(QPrinter * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QPrintPreviewDialog::paintRequested)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QPrintPreviewDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_QPrintPreviewDialog.data,
    qt_meta_data_QPrintPreviewDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
