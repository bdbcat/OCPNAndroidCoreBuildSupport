...
public:
    ...
    void setupUi(QWidget *QPageSetupWidget)
    {
        ...
        pageSizeWarningLabel = new QLabel(groupBox_2);
        pageSizeWarningLabel->setObjectName(QString::fromUtf8("pageSizeWarningLabel"));

        gridLayout_2->addWidget(pageSizeWarningLabel, 0, 2, 1, 1);
