...
#include "../../../../../qtbase/src/sql/models/qsqltablemodel.h"
...
void QSqlTableModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QSqlTableModel::*)(int , QSqlRecord & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QSqlTableModel::primeInsert)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QSqlTableModel::*)(QSqlRecord & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QSqlTableModel::beforeInsert)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QSqlTableModel::*)(int , QSqlRecord & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QSqlTableModel::beforeUpdate)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QSqlTableModel::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QSqlTableModel::beforeDelete)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QSqlTableModel::staticMetaObject = { {
    &QSqlQueryModel::staticMetaObject,
    qt_meta_stringdata_QSqlTableModel.data,
    qt_meta_data_QSqlTableModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
