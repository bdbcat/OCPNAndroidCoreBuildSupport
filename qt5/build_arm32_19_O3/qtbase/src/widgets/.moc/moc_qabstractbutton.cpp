...
void QAbstractButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QAbstractButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QAbstractButton::pressed)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QAbstractButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QAbstractButton::released)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QAbstractButton::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QAbstractButton::clicked)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QAbstractButton::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QAbstractButton::toggled)) {
                *result = 4;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QAbstractButton::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_QAbstractButton.data,
