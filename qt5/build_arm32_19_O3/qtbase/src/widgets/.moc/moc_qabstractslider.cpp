...
void QAbstractSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QAbstractSlider::valueChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QAbstractSlider::sliderPressed)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QAbstractSlider::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QAbstractSlider::sliderMoved)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QAbstractSlider::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QAbstractSlider::sliderReleased)) {
                *result = 3;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QAbstractSlider::rangeChanged)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (QAbstractSlider::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QAbstractSlider::actionTriggered)) {
                *result = 5;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QAbstractSlider::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_QAbstractSlider.data,
    qt_meta_data_QAbstractSlider,
    qt_static_metacall,
    nullptr,
    nullptr
} };
