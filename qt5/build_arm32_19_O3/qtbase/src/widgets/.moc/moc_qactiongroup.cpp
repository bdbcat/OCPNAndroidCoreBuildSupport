...
#include "../../../../../qtbase/src/widgets/kernel/qactiongroup.h"
...
void QActionGroup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QActionGroup::*)(QAction * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QActionGroup::triggered)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QActionGroup::*)(QAction * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QActionGroup::hovered)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QActionGroup::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QActionGroup.data,
    qt_meta_data_QActionGroup,
    qt_static_metacall,
    nullptr,
    nullptr
} };
