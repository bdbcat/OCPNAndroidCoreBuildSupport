...
void QButtonGroup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QButtonGroup::buttonClicked)) {
                *result = 0;
                return;
            }
        }
        ...
        {
            using _t = void (QButtonGroup::*)(QAbstractButton * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QButtonGroup::buttonPressed)) {
                *result = 2;
                return;
            }
        }
        ...
        {
            using _t = void (QButtonGroup::*)(QAbstractButton * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QButtonGroup::buttonReleased)) {
                *result = 4;
                return;
            }
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QButtonGroup::buttonToggled)) {
                *result = 6;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QButtonGroup::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QButtonGroup.data,
    qt_meta_data_QButtonGroup,
    qt_static_metacall,
    nullptr,
    nullptr
} };
