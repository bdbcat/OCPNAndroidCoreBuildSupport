...
void QCalendarWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QCalendarWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QCalendarWidget::selectionChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QCalendarWidget::*)(const QDate & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QCalendarWidget::clicked)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QCalendarWidget::*)(const QDate & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QCalendarWidget::activated)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QCalendarWidget::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QCalendarWidget::currentPageChanged)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QCalendarWidget::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_QCalendarWidget.data,
    qt_meta_data_QCalendarWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
