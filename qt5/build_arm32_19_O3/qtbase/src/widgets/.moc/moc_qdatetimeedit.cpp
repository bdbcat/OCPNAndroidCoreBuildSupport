...
void QDateTimeEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QDateTimeEdit::*)(const QDateTime & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDateTimeEdit::dateTimeChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QDateTimeEdit::*)(const QTime & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDateTimeEdit::timeChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QDateTimeEdit::*)(const QDate & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDateTimeEdit::dateChanged)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QDateTimeEdit::staticMetaObject = { {
    &QAbstractSpinBox::staticMetaObject,
    qt_meta_stringdata_QDateTimeEdit.data,
    qt_meta_data_QDateTimeEdit,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void QTimeEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (QTimeEdit::*)(const QTime & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTimeEdit::userTimeChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QTimeEdit::staticMetaObject = { {
    &QDateTimeEdit::staticMetaObject,
    qt_meta_stringdata_QTimeEdit.data,
    qt_meta_data_QTimeEdit,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void QDateEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (QDateEdit::*)(const QDate & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDateEdit::userDateChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QDateEdit::staticMetaObject = { {
    &QDateTimeEdit::staticMetaObject,
    qt_meta_stringdata_QDateEdit.data,
    qt_meta_data_QDateEdit,
    qt_static_metacall,
    nullptr,
    nullptr
} };
