...
void QCalendarPopup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QCalendarPopup::*)(const QDate & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QCalendarPopup::activated)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QCalendarPopup::*)(const QDate & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QCalendarPopup::newDateSelected)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QCalendarPopup::*)(const QDate & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QCalendarPopup::hidingCalendar)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QCalendarPopup::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QCalendarPopup::resetButton)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QCalendarPopup::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_QCalendarPopup.data,
    qt_meta_data_QCalendarPopup,
    qt_static_metacall,
    nullptr,
    nullptr
} };
