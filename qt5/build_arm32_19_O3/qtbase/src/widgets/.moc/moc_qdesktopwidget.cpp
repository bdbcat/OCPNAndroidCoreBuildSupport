...
#include "../../../../../qtbase/src/widgets/kernel/qdesktopwidget.h"
...
void QDesktopWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QDesktopWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QDesktopWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDesktopWidget::resized)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QDesktopWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDesktopWidget::workAreaResized)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QDesktopWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDesktopWidget::screenCountChanged)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QDesktopWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDesktopWidget::primaryScreenChanged)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QDesktopWidget::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_QDesktopWidget.data,
    qt_meta_data_QDesktopWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
