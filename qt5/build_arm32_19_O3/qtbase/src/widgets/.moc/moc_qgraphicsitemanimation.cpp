...
#include "../../../../../qtbase/src/widgets/graphicsview/qgraphicsitemanimation.h"
...
void QGraphicsItemAnimation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QGraphicsItemAnimation *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QGraphicsItemAnimation::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QGraphicsItemAnimation.data,
    qt_meta_data_QGraphicsItemAnimation,
    qt_static_metacall,
    nullptr,
    nullptr
} };
