...
QT_INIT_METAOBJECT const QMetaObject QGraphicsSceneBspTreeIndex::staticMetaObject = { {
    &QGraphicsSceneIndex::staticMetaObject,
    qt_meta_stringdata_QGraphicsSceneBspTreeIndex.data,
    qt_meta_data_QGraphicsSceneBspTreeIndex,
    qt_static_metacall,
    nullptr,
    nullptr
} };
