...
QT_INIT_METAOBJECT const QMetaObject QGraphicsTransform::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QGraphicsTransform.data,
    qt_meta_data_QGraphicsTransform,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void QGraphicsScale::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QGraphicsScale::originChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QGraphicsScale::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QGraphicsScale::xScaleChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QGraphicsScale::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QGraphicsScale::yScaleChanged)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QGraphicsScale::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QGraphicsScale::zScaleChanged)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (QGraphicsScale::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QGraphicsScale::scaleChanged)) {
                *result = 4;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QGraphicsScale::staticMetaObject = { {
    &QGraphicsTransform::staticMetaObject,
    qt_meta_stringdata_QGraphicsScale.data,
    qt_meta_data_QGraphicsScale,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void QGraphicsRotation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QGraphicsRotation::originChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QGraphicsRotation::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QGraphicsRotation::angleChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QGraphicsRotation::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QGraphicsRotation::axisChanged)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QGraphicsRotation::staticMetaObject = { {
    &QGraphicsTransform::staticMetaObject,
    qt_meta_stringdata_QGraphicsRotation.data,
    qt_meta_data_QGraphicsRotation,
    qt_static_metacall,
    nullptr,
    nullptr
} };
