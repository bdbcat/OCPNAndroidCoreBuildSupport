...
QT_MOC_LITERAL(13, 196, 11) // "QModelIndex"
    ...
    "_q_currentRowChanged\0QModelIndex"
};
...
void QInputDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QInputDialog::textValueChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QInputDialog::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QInputDialog::textValueSelected)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QInputDialog::intValueChanged)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QInputDialog::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QInputDialog::intValueSelected)) {
                *result = 3;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QInputDialog::doubleValueChanged)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (QInputDialog::*)(double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QInputDialog::doubleValueSelected)) {
                *result = 5;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QInputDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_QInputDialog.data,
    qt_meta_data_QInputDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
