...
#include "../../../../../qtbase/src/widgets/statemachine/qkeyeventtransition.h"
...
void QKeyEventTransition::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<QKeyEventTransition *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QKeyEventTransition::staticMetaObject = { {
    &QEventTransition::staticMetaObject,
    qt_meta_stringdata_QKeyEventTransition.data,
    qt_meta_data_QKeyEventTransition,
    qt_static_metacall,
    nullptr,
    nullptr
} };
