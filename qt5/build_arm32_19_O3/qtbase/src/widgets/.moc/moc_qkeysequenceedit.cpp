...
void QKeySequenceEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QKeySequenceEdit::editingFinished)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QKeySequenceEdit::keySequenceChanged)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QKeySequenceEdit::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_QKeySequenceEdit.data,
    qt_meta_data_QKeySequenceEdit,
    qt_static_metacall,
    nullptr,
    nullptr
} };
