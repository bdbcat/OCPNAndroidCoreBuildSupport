...
QT_MOC_LITERAL(24, 328, 11), // "QModelIndex"
QT_MOC_LITERAL(25, 340, 5), // "index"
QT_MOC_LITERAL(26, 346, 18), // "_q_emitItemClicked"
QT_MOC_LITERAL(27, 365, 24), // "_q_emitItemDoubleClicked"
QT_MOC_LITERAL(28, 390, 20), // "_q_emitItemActivated"
QT_MOC_LITERAL(29, 411, 18), // "_q_emitItemEntered"
QT_MOC_LITERAL(30, 430, 18), // "_q_emitItemChanged"
QT_MOC_LITERAL(31, 449, 25), // "_q_emitCurrentItemChanged"
QT_MOC_LITERAL(32, 475, 7), // "_q_sort"
QT_MOC_LITERAL(33, 483, 14), // "_q_dataChanged"
QT_MOC_LITERAL(34, 498, 7), // "topLeft"
QT_MOC_LITERAL(35, 506, 11), // "bottomRight"
QT_MOC_LITERAL(36, 518, 5), // "count"
QT_MOC_LITERAL(37, 524, 14) // "sortingEnabled"
    ...
    "clear\0_q_emitItemPressed\0QModelIndex\0"
    "index\0_q_emitItemClicked\0"
...
static const uint qt_meta_data_QListWidget[] = {
 ...
 // slots: parameters
    ...
    QMetaType::Void, 0x80000000 | 24,   25,
    QMetaType::Void, 0x80000000 | 24,   25,
    QMetaType::Void, 0x80000000 | 24, 0x80000000 | 24,   12,   11,
    QMetaType::Void,
    QMetaType::Void, 0x80000000 | 24, 0x80000000 | 24,   34,   35,
...
void QListWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QListWidget::*)(QListWidgetItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QListWidget::itemPressed)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QListWidget::*)(QListWidgetItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QListWidget::itemClicked)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QListWidget::*)(QListWidgetItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QListWidget::itemDoubleClicked)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QListWidget::*)(QListWidgetItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QListWidget::itemActivated)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (QListWidget::*)(QListWidgetItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QListWidget::itemEntered)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (QListWidget::*)(QListWidgetItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QListWidget::itemChanged)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (QListWidget::*)(QListWidgetItem * , QListWidgetItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QListWidget::currentItemChanged)) {
                *result = 6;
                return;
            }
        }
        {
            using _t = void (QListWidget::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QListWidget::currentTextChanged)) {
                *result = 7;
                return;
            }
        }
        {
            using _t = void (QListWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QListWidget::currentRowChanged)) {
                *result = 8;
                return;
            }
        }
        {
            using _t = void (QListWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QListWidget::itemSelectionChanged)) {
                *result = 9;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QListWidget::staticMetaObject = { {
    &QListView::staticMetaObject,
    qt_meta_stringdata_QListWidget.data,
    qt_meta_data_QListWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
