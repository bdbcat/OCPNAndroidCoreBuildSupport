...
void QMdiArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QMdiArea::*)(QMdiSubWindow * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QMdiArea::subWindowActivated)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QMdiArea::staticMetaObject = { {
    &QAbstractScrollArea::staticMetaObject,
    qt_meta_stringdata_QMdiArea.data,
    qt_meta_data_QMdiArea,
    qt_static_metacall,
    qt_meta_extradata_QMdiArea,
    nullptr
} };
