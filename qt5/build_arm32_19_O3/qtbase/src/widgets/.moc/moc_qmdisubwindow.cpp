...
void QMdiSubWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QMdiSubWindow::*)(Qt::WindowStates , Qt::WindowStates );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QMdiSubWindow::windowStateChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QMdiSubWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QMdiSubWindow::aboutToActivate)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QMdiSubWindow::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_QMdiSubWindow.data,
    qt_meta_data_QMdiSubWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
