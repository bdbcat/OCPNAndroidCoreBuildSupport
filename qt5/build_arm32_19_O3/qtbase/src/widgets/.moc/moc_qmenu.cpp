...
void QMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QMenu::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QMenu::aboutToShow)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QMenu::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QMenu::aboutToHide)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QMenu::triggered)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QMenu::*)(QAction * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QMenu::hovered)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QMenu::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_QMenu.data,
    qt_meta_data_QMenu,
    qt_static_metacall,
    nullptr,
    nullptr
