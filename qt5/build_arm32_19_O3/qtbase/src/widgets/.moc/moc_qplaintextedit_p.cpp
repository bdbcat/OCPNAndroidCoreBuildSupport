...
QT_INIT_METAOBJECT const QMetaObject QPlainTextEditControl::staticMetaObject = { {
    &QWidgetTextControl::staticMetaObject,
    qt_meta_stringdata_QPlainTextEditControl.data,
    qt_meta_data_QPlainTextEditControl,
    qt_static_metacall,
    nullptr,
    nullptr
} };
