...
#include "../../../../../qtbase/src/widgets/dialogs/qprogressdialog.h"
...
void QProgressDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QProgressDialog::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QProgressDialog::canceled)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QProgressDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_QProgressDialog.data,
    qt_meta_data_QProgressDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
