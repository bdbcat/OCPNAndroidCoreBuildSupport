...
void QSplashScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QSplashScreen::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QSplashScreen::messageChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QSplashScreen::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_QSplashScreen.data,
    qt_meta_data_QSplashScreen,
    qt_static_metacall,
    nullptr,
    nullptr
} };
