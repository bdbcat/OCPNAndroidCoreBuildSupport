...
void QSplitter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QSplitter::splitterMoved)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QSplitter::staticMetaObject = { {
    &QFrame::staticMetaObject,
    qt_meta_stringdata_QSplitter.data,
    qt_meta_data_QSplitter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject QSplitterHandle::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_QSplitterHandle.data,
    qt_meta_data_QSplitterHandle,
    qt_static_metacall,
    nullptr,
    nullptr
} };
