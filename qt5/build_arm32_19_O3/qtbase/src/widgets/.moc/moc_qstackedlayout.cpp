...
#include "../../../../../qtbase/src/widgets/kernel/qstackedlayout.h"
...
void QStackedLayout::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QStackedLayout::widgetRemoved)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QStackedLayout::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QStackedLayout::currentChanged)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QStackedLayout::staticMetaObject = { {
    &QLayout::staticMetaObject,
    qt_meta_stringdata_QStackedLayout.data,
    qt_meta_data_QStackedLayout,
    qt_static_metacall,
    nullptr,
    nullptr
} };
