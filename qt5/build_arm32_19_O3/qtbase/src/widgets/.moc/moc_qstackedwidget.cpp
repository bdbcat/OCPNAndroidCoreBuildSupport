...
#include "../../../../../qtbase/src/widgets/widgets/qstackedwidget.h"
...
void QStackedWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QStackedWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QStackedWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QStackedWidget::currentChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QStackedWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QStackedWidget::widgetRemoved)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QStackedWidget::staticMetaObject = { {
    &QFrame::staticMetaObject,
    qt_meta_stringdata_QStackedWidget.data,
    qt_meta_data_QStackedWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
