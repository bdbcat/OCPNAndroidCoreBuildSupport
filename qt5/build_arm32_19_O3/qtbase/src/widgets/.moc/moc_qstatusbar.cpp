...
#include "../../../../../qtbase/src/widgets/widgets/qstatusbar.h"
...
void QStatusBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QStatusBar::messageChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QStatusBar::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_QStatusBar.data,
    qt_meta_data_QStatusBar,
    qt_static_metacall,
    nullptr,
    nullptr
} };
