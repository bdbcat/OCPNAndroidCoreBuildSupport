...
void QTabBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTabBar::currentChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QTabBar::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTabBar::tabCloseRequested)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTabBar::tabMoved)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QTabBar::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTabBar::tabBarClicked)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (QTabBar::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTabBar::tabBarDoubleClicked)) {
                *result = 4;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QTabBar::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_QTabBar.data,
    qt_meta_data_QTabBar,
    qt_static_metacall,
    nullptr,
    nullptr
} };
