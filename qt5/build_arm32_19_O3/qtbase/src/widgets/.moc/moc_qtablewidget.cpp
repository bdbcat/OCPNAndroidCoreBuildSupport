...
QT_MOC_LITERAL(38, 493, 11), // "QModelIndex"
QT_MOC_LITERAL(39, 505, 5), // "index"
QT_MOC_LITERAL(40, 511, 18), // "_q_emitItemClicked"
QT_MOC_LITERAL(41, 530, 24), // "_q_emitItemDoubleClicked"
QT_MOC_LITERAL(42, 555, 20), // "_q_emitItemActivated"
QT_MOC_LITERAL(43, 576, 18), // "_q_emitItemEntered"
QT_MOC_LITERAL(44, 595, 18), // "_q_emitItemChanged"
QT_MOC_LITERAL(45, 614, 25), // "_q_emitCurrentItemChanged"
QT_MOC_LITERAL(46, 640, 7), // "_q_sort"
QT_MOC_LITERAL(47, 648, 14), // "_q_dataChanged"
QT_MOC_LITERAL(48, 663, 7), // "topLeft"
QT_MOC_LITERAL(49, 671, 11), // "bottomRight"
QT_MOC_LITERAL(50, 683, 8), // "rowCount"
QT_MOC_LITERAL(51, 692, 11) // "columnCount"
    ...
    "bottomRight\0rowCount\0columnCount"
};
...
static const uint qt_meta_data_QTableWidget[] = {
 ...
 // slots: name, argc, parameters, tag, flags
      ...
      43,    1,  271,    2, 0x08 /* Private */,
      44,    1,  274,    2, 0x08 /* Private */,
      45,    2,  277,    2, 0x08 /* Private */,
...
void QTableWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTableWidget::itemPressed)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QTableWidget::*)(QTableWidgetItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTableWidget::itemClicked)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QTableWidget::*)(QTableWidgetItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTableWidget::itemDoubleClicked)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QTableWidget::*)(QTableWidgetItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTableWidget::itemActivated)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (QTableWidget::*)(QTableWidgetItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTableWidget::itemEntered)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (QTableWidget::*)(QTableWidgetItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTableWidget::itemChanged)) {
                *result = 5;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTableWidget::currentItemChanged)) {
                *result = 6;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTableWidget::itemSelectionChanged)) {
                *result = 7;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTableWidget::cellPressed)) {
                *result = 8;
                return;
            }
        }
        {
            using _t = void (QTableWidget::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTableWidget::cellClicked)) {
                *result = 9;
                return;
            }
        }
        {
            using _t = void (QTableWidget::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTableWidget::cellDoubleClicked)) {
                *result = 10;
                return;
            }
        }
        {
            using _t = void (QTableWidget::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTableWidget::cellActivated)) {
                *result = 11;
                return;
            }
        }
        {
            using _t = void (QTableWidget::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTableWidget::cellEntered)) {
                *result = 12;
                return;
            }
        }
        {
            using _t = void (QTableWidget::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTableWidget::cellChanged)) {
                *result = 13;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTableWidget::currentCellChanged)) {
                *result = 14;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QTableWidget::staticMetaObject = { {
    &QTableView::staticMetaObject,
    qt_meta_stringdata_QTableWidget.data,
    qt_meta_data_QTableWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
