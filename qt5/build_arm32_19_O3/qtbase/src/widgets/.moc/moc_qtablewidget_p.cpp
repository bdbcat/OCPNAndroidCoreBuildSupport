...
QT_INIT_METAOBJECT const QMetaObject QTableWidgetMimeData::staticMetaObject = { {
    &QMimeData::staticMetaObject,
    qt_meta_stringdata_QTableWidgetMimeData.data,
    qt_meta_data_QTableWidgetMimeData,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject QTableModel::staticMetaObject = { {
    &QAbstractTableModel::staticMetaObject,
    qt_meta_stringdata_QTableModel.data,
