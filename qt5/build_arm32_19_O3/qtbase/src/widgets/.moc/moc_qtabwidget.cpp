...
void QTabWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTabWidget::currentChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QTabWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTabWidget::tabCloseRequested)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QTabWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTabWidget::tabBarClicked)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QTabWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTabWidget::tabBarDoubleClicked)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QTabWidget::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_QTabWidget.data,
    qt_meta_data_QTabWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
