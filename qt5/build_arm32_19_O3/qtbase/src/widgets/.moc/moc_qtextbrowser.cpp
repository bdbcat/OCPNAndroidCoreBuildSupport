...
void QTextBrowser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QTextBrowser::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTextBrowser::backwardAvailable)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QTextBrowser::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTextBrowser::forwardAvailable)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QTextBrowser::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTextBrowser::historyChanged)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QTextBrowser::*)(const QUrl & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTextBrowser::sourceChanged)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (QTextBrowser::*)(const QUrl & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTextBrowser::highlighted)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (QTextBrowser::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTextBrowser::highlighted)) {
                *result = 5;
                return;
            }
        ...
        {
            using _t = void (QTextBrowser::*)(const QUrl & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTextBrowser::anchorClicked)) {
                *result = 6;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QTextBrowser::staticMetaObject = { {
    &QTextEdit::staticMetaObject,
    qt_meta_stringdata_QTextBrowser.data,
    qt_meta_data_QTextBrowser,
    qt_static_metacall,
    nullptr,
    nullptr
} };
