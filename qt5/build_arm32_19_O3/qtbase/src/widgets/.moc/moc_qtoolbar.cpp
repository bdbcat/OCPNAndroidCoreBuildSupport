...
void QToolBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QToolBar::*)(QAction * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QToolBar::actionTriggered)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QToolBar::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QToolBar::movableChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QToolBar::*)(Qt::ToolBarAreas );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QToolBar::allowedAreasChanged)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QToolBar::*)(Qt::Orientation );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QToolBar::orientationChanged)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (QToolBar::*)(const QSize & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QToolBar::iconSizeChanged)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (QToolBar::*)(Qt::ToolButtonStyle );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QToolBar::toolButtonStyleChanged)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (QToolBar::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QToolBar::topLevelChanged)) {
                *result = 6;
                return;
            }
        }
        {
            using _t = void (QToolBar::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QToolBar::visibilityChanged)) {
                *result = 7;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QToolBar::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_QToolBar.data,
    qt_meta_data_QToolBar,
    qt_static_metacall,
    nullptr,
    nullptr
} };
