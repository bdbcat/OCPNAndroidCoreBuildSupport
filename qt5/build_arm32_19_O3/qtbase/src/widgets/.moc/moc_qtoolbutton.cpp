...
void QToolButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QToolButton::*)(QAction * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QToolButton::triggered)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QToolButton::staticMetaObject = { {
    &QAbstractButton::staticMetaObject,
    qt_meta_stringdata_QToolButton.data,
    qt_meta_data_QToolButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
