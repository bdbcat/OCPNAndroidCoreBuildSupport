...
#include "../../../../../qtbase/src/widgets/util/qundogroup.h"
...
void QUndoGroup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QUndoGroup::activeStackChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QUndoGroup::indexChanged)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QUndoGroup::cleanChanged)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QUndoGroup::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QUndoGroup::canUndoChanged)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (QUndoGroup::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QUndoGroup::canRedoChanged)) {
                *result = 4;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QUndoGroup::undoTextChanged)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (QUndoGroup::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QUndoGroup::redoTextChanged)) {
                *result = 6;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QUndoGroup::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QUndoGroup.data,
    qt_meta_data_QUndoGroup,
    qt_static_metacall,
    nullptr,
    nullptr
} };
